...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        print('Prepare bounding box by loading a nice font')
        fontpath = os.path.abspath('/home/student/catkin_ws/src/door_detector/src/detector/font/FiraMono-Medium.otf')
